...
public class GigRepository extends RepositoryBase<Gig> implements IGigRepository {
	...
	protected String insertSql() {
		return "INSERT INTO user(category, title, description) VALUES (?,?,?)";
	}

	protected String updateSql() {
		return "UPDATE user SET (category, title, description)=(?,?,?) WHERE id=?";
	}

	protected String getCategorySql() {
		return "SELECT * FROM user where category = ?";
	}

	protected String getTitleSql() {
		return "SELECT * FROM user where title=?";
	}
